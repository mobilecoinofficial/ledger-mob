//! Stored settings for the MobileCoin Ledger app

// TODO(ryan): settings rebuild should be a separate PR that we can land on both target families?
...
// TODO: port over the fog selection to here
pub const SETTINGS_STRINGS: &[[&str; 2]] = &[["Fog ID", "Select a fog network"]];
