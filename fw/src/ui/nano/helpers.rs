...
// Hex helpers are shared with the touch UI, re-exported here so existing
// nano call-sites keep working unchanged.
pub use super::super::{to_hex, to_hex_slice, to_hex_str};
