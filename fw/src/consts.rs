...
pub const MOB16X16: Glyph = Glyph::from_include(include_gif!("assets/mob16x16.png", BAGL));
...
/// Mob logo in 32x32
#[cfg(any(target_os = "nanox", target_os = "nanosplus"))]
pub const MOB32X32: Glyph = Glyph::from_include(include_gif!("assets/mob32x32.png", BAGL));
